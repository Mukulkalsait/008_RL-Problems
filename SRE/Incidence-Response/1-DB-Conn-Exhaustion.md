# 🚨 INCIDENT SCENARIO (LIVE ON-CALL)
...
Excellent. This is **solid junior–mid SRE level thinking** already.
I’ll **grade you**, then **correct + upgrade** your answers so they become **interview-ready**.
...
* Chose rollback (✅ very SRE-correct)
* Thought about alert improvements (very good)

Now let’s **tighten the weak points**.

---

# 🔧 Corrections & Improvements (Important)

## 1️⃣ Immediate Actions (On-Call)

### What you did right

* PagerDuty **ACK** ✅
* Recognized revenue-impacting service ✅
* Considered recent deploy ✅

### What to improve (INTERVIEW KEY)

Instead of saying:

> “alert may be false but still check”

Say this:

> “The alert is valid because it breaches SLOs for 12 minutes on a revenue-critical service.”
...
🔥 **Keyword interviewers want**: *“stop escalation, confirm SLO breach”*

---

## 2️⃣ Investigation (Very Good, One Fix)

### Your logic

> DB connections maxed out → bad push or traffic

Correct 👍
But this line is slightly weak:

> “High traffic will affect overall not just DB”
...
🔥 **Interview keyword**: *connection leak*

---

## 3️⃣ Mitigation (Good Choice, Slight Adjustment)
...
🔥 **This sentence alone passes SRE interviews**.

---

## 4️⃣ Communication (Good, Make It SRE-Style)
...
🔥 Short. Clear. No screenshots during outage.

---

## 5️⃣ Post-Incident Actions (Very Strong)
...
🔥 **Postmortem is sacred in SRE**.

---

# 🔐 Security Attacks You MUST Know (Answer to your earlier question)
...
> “I have no idea about on-call, incidents”
...
* Linux Admin → ✅
* Junior DevOps → ✅
* SRE (Junior/Mid) → borderline but possible
